      ...
      `https://api.hubapi.com/crm/v3/objects/deals/${parseInt(idHubSpot)}`,
      {
        ...
        body: JSON.stringify({
          properties: {
            ...
            documento_comprador_1: updateData['doccomprador'],
            compradorcorreo,
            compradorcelular,
            nombrecomprador,
            desistimiento,
            ...
            invdescunidad,
            invtipoinmueble,
            area_privada: updateData['invarprivada'],
            area_construida: updateData['invarconstruida'],
            numeroencargofiduciario,
            escriturafecha,
            valorarras,
            fechadesistimientos,
            amount: updateData['valorventaagrupacion'],
            escriturano,
            escrituravalor,
